...
import mapboxgl, { GeolocateControl, Map, Marker, NavigationControl, Popup } from "mapbox-gl"
            ...
            handler(e) {
              if (mapRef.current && e.feature) {
                ...
                if (e.feature.geometry.type == "Point") {
                  ...
                  const coordinates = e.feature.geometry.coordinates.slice() as [number, number];
                  // this is known
                  const properties = e.feature.properties as unknown as StationProperties
