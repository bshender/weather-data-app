  ...
  return (
    <Card>
      ...
      <div className="pt-text-box">
        <EntityTitle
          fill
          title={`${selectedPoint?.lat}, ${selectedPoint?.lng}`}
          icon={MapMarkerButton}
        />
        <br />
        <div>
          <span>CWA:</span>
          <span>{pointData.properties.cwa}</span>
        </div>
        <div>
          <span>Grid ID:</span>
          <span>{pointData.properties.gridId}</span>
        </div>
        <div>
          <span>Radar Station:</span>
          <span>{pointData.properties.radarStation}</span>
        </div>
      </div>
      <Button
        icon="area-of-interest"
        intent="success"
        text="Show Related Stations"
